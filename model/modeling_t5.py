...
class T5Attention(nn.Module):
    ...
    def forward(
        ...
        # print("attn_weights {}, value_states {}".format(attn_weights.shape,value_states.shape))
...
class T5Block(nn.Module):
    def __init__(self, config, has_relative_attention_bias=False,ret=None):
        super().__init__()
        self.is_decoder = config.is_decoder
        ...
        if self.is_decoder:
            ...
            if ret is not None:
                ...
                # self.layer.append(MCA(dim=768,num_heads=8))
    ...
    def forward(
        ...
        if do_cross_attention:
            ...
            # print("hidden states output: ",hidden_states.shape)
            #############
...
class T5Stack(T5PreTrainedModel):
    def __init__(self, config, embed_tokens=None,ret=None):
        ...
        self.block = nn.ModuleList(
            [T5Block(config, has_relative_attention_bias=bool(i == 0),ret=ret) for i in range(config.num_layers)]
        )
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def __init__(self, config: T5Config, encoder_dropout=0., decoder_dropout=0.1, label_smoothing=0.1, is_gated_act=False,args=None):
